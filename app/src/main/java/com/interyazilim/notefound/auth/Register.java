package com.interyazilim.notefound.auth;
...
import com.interyazilim.notefound.MainActivity;
import com.interyazilim.notefound.R;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Connect to Note Found");
        ...
        syncAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (uUserPass.length()<6){
                    Toast.makeText(Register.this, "The given password is invalid [ Password should be at least 6 characters ]", Toast.LENGTH_SHORT).show();
                    return;
                }
