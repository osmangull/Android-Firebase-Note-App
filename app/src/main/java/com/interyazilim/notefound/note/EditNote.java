package com.interyazilim.notefound.note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DocumentReference docref = fStore.collection("note").document(user.getUid()).collection("myNotes").document(data.getStringExtra("noteId"));
